...
async def sh1(message: types.Message):
 ...
 <b>Bot by </b> -» <a href="tg://user?id=796121550"><b>HOLY CARDERS</b></a>
           """)
...
async def igfgnfokc(message: types.Message):
 ...
 Bot by -» <a href="tg://user?id=796121550">HOLY CARDERS</a>
 """
...
async def igfgnfokc(message: types.Message):
 ...
 <b>generated by</b> -» <a href="tg://user?id=796121550"{message.from_user.id}">{message.from_user.first_name}</a>
 </b>
   """
